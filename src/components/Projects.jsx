          ...
          {projects.map((project, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="font-mono text-lg font-semibold text-white mb-3">{project.title}</h3>
                  ...
                  {/* Tech badges */}
                  <div className="flex flex-wrap gap-2 mt-auto pt-4 border-t border-dark-600/30">
                    {project.tech.map((t) => (
